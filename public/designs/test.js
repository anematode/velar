    ...
    render() {
        return (
            ...
            <span className="add-equation-label">
              ...
              <span className="icon" data-octicon="plus"></span>
            </span>
                    <div className="add-equation-wrapper">
                        <div className="add-equation-dialog" role="group">
                            <button className="add-type">
                                <span className="icon" data-octicon="graph"></span>
                                Graph
                            </button>
                            <button className="add-type">
                                <span className="icon" data-octicon="note"></span>
                                Note
                            </button>
                        </div>
                    </div>
            ...
            <div className="mobile-menu-wrapper">
                <div className="logo-wrapper">
                    <button className="menu-btn icon-btn" id="_temp-open-menu-btn">
                        <span className="icon" data-octicon="three-bars">Open menu</span>
                    </button>
                    <button className="close-menu-btn icon-btn" id="_temp-close-menu-btn">
                        <span className="icon" data-octicon="x">Close menu</span>
                    </button>
    ...
    render() {
        return (
            ...
            <button className="settings-btn icon-btn" id="_temp-settings-btn">
                <span className="icon" data-octicon="gear">Graphing settings</span>
            </button>
            <div className="settings-wrapper">
                What settings should Grapheme have here? Can't have too many, or it'll be overwhelming.<br/>
                Actually, what'd be cool is if there could be a demo for each option, so students can learn what each
                option does and is meant for.<br />
        ...
        return (
            <React.Fragment>
               ...
               <main className="main">
                   ...
                   <div className="resize-equations"></div>
