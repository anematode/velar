    ...
    return (
      <div className={styles.wrapper}>
        <div className={styles.quickActions} onClick={this.handleDontHide}>
          <IconBtn className={classNames(styles.quickAction, styles.danger)} onClick={onRemove}>
            <TrashcanIcon aria-label='Remove' className={styles.icon} />
          </IconBtn>
          <IconBtn className={classNames(styles.quickAction, hidden && styles.equationHidden)} onClick={onToggleVisibility}>
